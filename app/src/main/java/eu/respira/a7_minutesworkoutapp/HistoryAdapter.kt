...
import eu.respira.a7_minutesworkoutapp.databinding.ItemHistoryRowBinding
...
class HistoryAdapter(private val items: ArrayList<String>) :
    ...
    /**
     * Inflates vizualizările articolului care sunt proiectate în fișierul xml
     *
    ...
    /**
     * Leagă fiecare element din ArrayList to a view
     *
     * Called when RecyclerView needs a new {@link ViewHolder} of the given type to represent
     * an item.
     *
     * Acest nou ViewHolder ar trebui să fie construit cu un nou View care pot reprezenta elementele
     * de tipul dat.
     */
