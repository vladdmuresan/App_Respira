...
abstract class HistoryDatabase:RoomDatabase(){
    ...
    /**
     * Definiți un obiect însoțitor, acest lucru ne permite să adăugăm funcții pe HistoryDatabase class.
     */
    companion object {
        /**
         ...
         *
         * Valoarea unei variabile volatile nu va fi niciodată memorată în cache și toate scrierile și
         *  citirile vor fi făcute către și din memoria principală. Înseamnă că modificările făcute de unul
         ...
         *
         * Această funcție este threadsafe, iar apelanții ar trebui sa depoziteze  rezultatul pentru mai multe baze de date
         *  pentru a evita overhead.
         *
         * Acesta este un exemplu de simplu Singleton model care ia alt Singleton ca un
         * argument in Kotlin.
         *
        ...
        fun getInstance(context: Context): HistoryDatabase {
            // Mai multe fire pot solicita baza de date în același timp, asigurați-vă că inițializam doar
            // o dată folosind sincronizat. Un singur fir poate intra într-un bloc sincronizat la un
            // timp.
            synchronized(this) {
